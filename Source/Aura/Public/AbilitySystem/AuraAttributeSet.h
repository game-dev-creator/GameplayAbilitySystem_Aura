...
public:
	...
	UFUNCTION()
	void OnRep_Armor(const FGameplayAttributeData& OldArmor) const; // Add Definition in AuraAttributeSet.cpp


	UFUNCTION()
	void OnRep_ArmorPenetration(const FGameplayAttributeData& OldArmorPenetration) const; // Add Definition in AuraAttributeSet.cpp


	UFUNCTION()
	void OnRep_BlockChance(const FGameplayAttributeData& OldBlockChance) const; // Add Definition in AuraAttributeSet.cpp


	UFUNCTION()
	void OnRep_CriticalHitChance(const FGameplayAttributeData& OldCriticalHitChance) const; // Add Definition in AuraAttributeSet.cpp


	UFUNCTION()
	void OnRep_CriticalHitDamage(const FGameplayAttributeData& OldCriticalHitDamage) const; // Add Definition in AuraAttributeSet.cpp


	UFUNCTION()
	void OnRep_CriticalHitResistance(const FGameplayAttributeData& OldCriticalHitResistance) const; // Add Definition in AuraAttributeSet.cpp


	UFUNCTION()
	void OnRep_HealthRegeneration(const FGameplayAttributeData& OldHealthRegeneration) const; // Add Definition in AuraAttributeSet.cpp


	UFUNCTION()
	void OnRep_ManaRegeneration(const FGameplayAttributeData& OldManaRegeneration) const; // Add Definition in AuraAttributeSet.cpp
